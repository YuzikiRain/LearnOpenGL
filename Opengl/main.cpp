...
int main()
{
	...
	// -------------------------
	Shader shader("Shader/unlit.vs", "Shader/unlit.fs");
	...
	// load textures
	// -------------
	unsigned int cubeTexture = loadTexture("Assets/Texture/marble.jpg");
	unsigned int floorTexture = loadTexture("Assets/Texture/metal.png");
